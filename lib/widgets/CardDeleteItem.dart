...
import 'package:karyasmk/screens/delete_screen/index_delete.dart';
import 'package:karyasmk/widgets/HexColor.dart';
import 'package:neumorphic/neumorphic.dart';

class CardDeleteItem extends StatelessWidget {
  final String idProduct;
  final String title;
  final String image;
  final num price;

  const CardDeleteItem(
      {Key key,
        ...
        onPressed: () {
          Navigator.push(
            ...
            new MaterialPageRoute(
              builder: (context) => new IndexDelete(
                endpoint: idProduct,
              ),
            ),
          );
